...
-- 12:48:35	Update `Server`  SET HireDate = '2020-01-01' WHERE HireDate > TermDate	Error Code: 1046. No database selected Select the default DB to be used by double-clicking its name in the SCHEMAS list in the sidebar.	0.0012 sec
